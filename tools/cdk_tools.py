# ---------------------------------------------------------------------------
# CDK Infrastructure Generation Tools for LangChain Agent
# ---------------------------------------------------------------------------
...
from templates.cdk_patterns import (
    generate_vpc_stack,
    generate_ecs_stack,
    generate_rds_stack,
...
# ---------------------------------------------------------------------------
# CDK Code Generation Templates
# ---------------------------------------------------------------------------

CDK_TEMPLATES = {
    "app_template": '''#!/usr/bin/env node
import 'source-map-support/register';
import * as cdk from 'aws-cdk-lib';
import { {stack_class_name} } from './lib/{stack_file_name}';

const app = new cdk.App();
new {stack_class_name}(app, '{stack_name}', {{
  env: {{
...
''',
    ...
    "stack_template": '''import * as cdk from 'aws-cdk-lib';
...
''',
    ...
    "package_json": '''{
  "name": "{project_name}-cdk",
  "version": "0.1.0",
  "bin": {
    "{project_name}-cdk": "bin/app.js"
  },
  "scripts": {
    "build": "tsc",
    "watch": "tsc -w",
...
def analyze_infrastructure_requirements(requirements: str) -> str:
    """
      Parse infrastructure requirements from Repository Analysis Agent output or user specifications.
      ...
      Args:
          requirements: JSON string from Repository Analysis Agent or plain text requirements
